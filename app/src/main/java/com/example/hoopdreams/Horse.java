...
public class Horse extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void onClick(View v) {
               session = helper.updateStats("0");
                ...
                if (session) {
                    ...
                    Toast.makeText(Horse.this,helper.calculateExperience(),Toast.LENGTH_SHORT).show();
                    //finish();
                }
            }
        });
        endSession.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                boolean success = databasehelper.addOne(helper.getTime(),helper.getShotsMade()[0],helper.getShotsTaken()[0], date[0],"H.O.R.S.E");
                boolean temp = databasehelper.addOne(helper.getTime(),helper.getShotsMade()[1],helper.getShotsTaken()[1], date[0],"H.O.R.S.E");
                Toast.makeText(Horse.this,helper.calculateExperience(),Toast.LENGTH_SHORT).show();
                finish();
            }
        });
    ...
    public void displayStats(){
        ArrayList<String> PlayerScore;
        PlayerScore = helper.displayScore();
        P1.setText(" " +PlayerScore.get(0));
        P2.setText(" " +PlayerScore.get(1));
    }
    ...
    private final BroadcastReceiver mGattUpdateReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (BluetoothLeService.ACTION_GATT_CONNECTED.equals(action)) {
                mConnected = true;
                Toast.makeText(Horse.this,"Connected to HoopDreamsDevice!",Toast.LENGTH_SHORT).show();
                invalidateOptionsMenu();
                Log.d(TAG,"Connected");
            } else if (BluetoothLeService.ACTION_GATT_DISCONNECTED.equals(action)) {
                mConnected = false;
                Toast.makeText(Horse.this,"Disconnected from HoopDreamsDevice!",Toast.LENGTH_SHORT).show();
                invalidateOptionsMenu();
    ...
    private void messageHandler() {
        if (receiveBuffer != null) {
            Toast.makeText(Horse.this, receiveBuffer, Toast.LENGTH_SHORT).show();
        }
        for(byte bi:receive){
