...
public class BluetoothLeService extends Service {
    ...
    public void setCharacteristicNotification(BluetoothGattCharacteristic characteristic,
        ...
        Log.d(TAG,"Setting Notifications on");
        // This is specific to Heart Rate Measurement.
        if ("19b10002-0000-1000-8000-00805f9b34fb".equals(characteristic.getUuid().toString())) {
            BluetoothGattDescriptor descriptor = characteristic.getDescriptor(
                    UUID.fromString("00002902-0000-1000-8000-00805f9b34fb"));
            //"00002902-e8f2-537e-4f6c-d104768a1214"
            Log.d(TAG, "Attempting to display descriptor");
            ...
            try{
                ...
                Log.e(TAG,"Descriptor Returned NULL");
            }
        }
    }
    ...
    public void writeCharacteristic(byte [] data)
    {
        try
        {
            BluetoothGattService Service = mBluetoothGatt.getService(UUID.fromString("19b10000-0000-1000-8000-00805f9b34fb"));
            BluetoothGattCharacteristic charac = Service.getCharacteristic(UUID.fromString("19b10001-0000-1000-8000-00805f9b34fb"));
            charac.setValue(data);

            Log.d(TAG,"Characteristic Writea " + data[0]);
            Log.d(TAG,"Characteristic Writeb " + data[1]);
            Log.d(TAG,"Characteristic Writec " + data[2]);
            Log.d(TAG,"Characteristic Writed " + data[3]);
            Log.d(TAG,"Characteristic Writee " + data[4]);
